 <!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Not Completed Task</li>
        </ol>
    </section>
   <!-- Main content -->
        ...
        <div class="col-md-12">
            <div class="panel panel-info" style="min-height:453px;">
                <div class="panel-heading">
                    <span>Not Completed Task</span>
                   
                </div>
                <div class="panel-body" style="overflow: scroll; height: 410px;">
               <accordion close-others="true">
                        <accordion-group ng-repeat="currenttasks in notcompleted">
                            <accordion-heading>
                   ...
                   <h2 ng-show="!notcompleted.length" class="md-display-3" layout="row" layout-align="center center">No Task Found</h2>
                    </accordion>
           </div>
            </div>
        </div>
