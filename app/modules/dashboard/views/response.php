 <!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a><i class="fa fa-dashboard"></i> Response Task</a></li>
        ...
        <div class="col-md-12">
            <div class="panel panel-info" style="min-height:453px;">
               ...
               <accordion close-others="true">
                        <accordion-group ng-repeat="currenttasks in response">
                            <accordion-heading>
                   ...
                   <h2 ng-show="!response.length" class="md-display-3" layout="row" layout-align="center center">No Task Found</h2>
                    </accordion>
           </div>
            </div>
        </div>
